...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Testing.created'
        db.add_column(u'event_calendar_testing', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Testing.modified'
        db.add_column(u'event_calendar_testing', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Testing.created'
        db.delete_column(u'event_calendar_testing', 'created')

        # Deleting field 'Testing.modified'
        db.delete_column(u'event_calendar_testing', 'modified')
