...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'event_calendar_event', 'slug',
                      self.gf('django_autoslug.fields.AutoSlugField')(default='', max_length=50, populate_from='name', recursive=False, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.slug'
        db.delete_column(u'event_calendar_event', 'slug')
    ...
    models = {
        ...
        'event_calendar.event': {
            ...
            'slug': ('django_autoslug.fields.AutoSlugField', [], {'max_length': '50', 'populate_from': "'name'", 'recursive': 'False', 'blank': 'True'}),
