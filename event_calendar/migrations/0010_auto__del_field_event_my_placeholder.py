...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.my_placeholder'
        db.delete_column(u'event_calendar_event', 'my_placeholder_id')


    def backwards(self, orm):
        # Adding field 'Event.my_placeholder'
        db.add_column(u'event_calendar_event', 'my_placeholder',
