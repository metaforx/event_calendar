...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'event_calendar_event_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            (u'master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['event_calendar.Event'])),
        ))
        db.send_create_signal('event_calendar', ['EventTranslation'])

        # Adding unique constraint on 'EventTranslation', fields ['language_code', u'master']
        db.create_unique(u'event_calendar_event_translation', ['language_code', u'master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventTranslation', fields ['language_code', u'master']
        db.delete_unique(u'event_calendar_event_translation', ['language_code', u'master_id'])
        ...
        db.delete_table(u'event_calendar_event_translation')
    ...
    models = {
        ...
        'event_calendar.testingtranslation': {
            'Meta': {'unique_together': "[(u'language_code', u'master')]", 'object_name': 'TestingTranslation', 'db_table': "u'event_calendar_testing_translation'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            u'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['event_calendar.Testing']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'filer.file': {
