...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'event_calendar_event', 'address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.zip_code'
        db.add_column(u'event_calendar_event', 'zip_code',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.city'
        db.add_column(u'event_calendar_event', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.coordinates'
        db.add_column(u'event_calendar_event', 'coordinates',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'event_calendar_event', 'address')

        # Deleting field 'Event.zip_code'
        db.delete_column(u'event_calendar_event', 'zip_code')

        # Deleting field 'Event.city'
        db.delete_column(u'event_calendar_event', 'city')

        # Deleting field 'Event.coordinates'
        db.delete_column(u'event_calendar_event', 'coordinates')
