...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'event_calendar_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('event_calendar', ['Category'])

        # Adding model 'Event'
        db.create_table(u'event_calendar_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event_calendar.Category'])),
            ('facebook_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('event_calendar', ['Event'])

        # Adding model 'EventListPlugin'
        db.create_table(u'event_calendar_eventlistplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event_calendar.Category'], null=True, blank=True)),
        ))
        db.send_create_signal(u'event_calendar', ['EventListPlugin'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'event_calendar_category')

        # Deleting model 'Event'
        db.delete_table(u'event_calendar_event')

        # Deleting model 'EventListPlugin'
        db.delete_table(u'event_calendar_eventlistplugin')
