...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'event_calendar_event', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Event.slug'
        db.alter_column(u'event_calendar_event', 'slug', self.gf('django_autoslug.fields.AutoSlugField')(max_length=50, populate_from='title', recursive=False))

    def backwards(self, orm):
        # Deleting field 'Event.published'
        db.delete_column(u'event_calendar_event', 'published')


        # Changing field 'Event.slug'
        db.alter_column(u'event_calendar_event', 'slug', self.gf('django_autoslug.fields.AutoSlugField')(max_length=50, populate_from='name', recursive=False))
