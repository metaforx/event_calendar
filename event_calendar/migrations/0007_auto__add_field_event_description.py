...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'event_calendar_event', 'description',
                      self.gf('django.db.models.fields.TextField')(default='adfsd'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.description'
        db.delete_column(u'event_calendar_event', 'description')
